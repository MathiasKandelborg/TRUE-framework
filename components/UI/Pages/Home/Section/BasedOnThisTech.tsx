...
const SectionBasedOnThisTech: React.FC = () => {
  ...
  return (
    <PageSection
      className={classes.sectionBasedOnThisTech}
      id="Based on this tech">
      <Grid item xs={12}>
        ...
        <Grid container justify="center">
          <Grid item xs={12} sm={7}>
            <Typography variant="body1" paragraph color="textSecondary">
              ...
              <br />
              Without MUI, there&apos;s no theme, no ready-to-use, optimized,
              and tested component library, that has incredible performance and
              supports accessibility with an A+ out of the box.
              <br />
              <br />
              There is truly much to be said about Material-UI, but one thing is
              certain... It is the ultimate DX while providing customizability
